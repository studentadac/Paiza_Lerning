//言語：Java
//問題URL：https://paiza.jp/works/mondai/dp_primer/dp_primer_recursive_formula_step3
//コメント：
//コード：
//```Java
import java.util.*;
public class Main {
    public static void main(String[] args) {
        ...
        Scanner sc = new Scanner(System.in);
         ...
         for (int i=1;i<k ;i++ )//範囲までの配列をあらかじめ作る
         {
             a[i]=a[i-1];
         ...
         {
            var ki=sc.nextInt()-1;
            System.out.println(a[ki]);//定められた数列の k_i 項目の値を順に出力する
         }
